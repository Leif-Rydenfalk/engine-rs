use ash::{
    ext::debug_utils,
    khr::{portability_enumeration, surface, swapchain},
...
fn create_vulkan_instance(
    ...
    extension_names.push(portability_enumeration::NAME.as_ptr()); // ADDED

    let instance_create_info = vk::InstanceCreateInfo::default()
        .application_info(&app_info)
        .flags(vk::InstanceCreateFlags::ENUMERATE_PORTABILITY_KHR) // ADDED
